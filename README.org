...
This is a project aiming to adapt the 0D foram model (Grigoratou et al. 2019) to include more foram group based on better coding structure.
...
#+begin_src python
    ...
    model.load_config("model_config.toml")
